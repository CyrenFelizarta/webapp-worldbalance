                ...
                <div class="bg-gray overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-gray border-b border-gray-200">
                          ...
                          <div class="mb-4">
                            ...
                            <input class="text-white border-2 border-gray-300 p-2 w-full rounded-lg" type="file" id="image" name="image" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="border-2 border-gray-300 p-2 w-full rounded-lg" name="title" id="title" value="{{old('title')}}" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="border-2 border-gray-300 p-2 w-full rounded-lg" name="description" id="description" value="{{old('description')}}" required>
