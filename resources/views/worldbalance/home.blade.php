                    ...
                    <div class="left-content">
                        <div class="thumb">
                            <div class="inner-content">
                                <h4>World Balance</h4>
                                <span>Step up your game</span>
                                <div class="main-border-button">
                                    <a href="{{route('about.index')}}">About Us</a>
                                </div>
                            </div>
                            <img src="{{asset('images/homepage_pic.jpg')}}" style="height:  19.3cm" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{asset('images/worldbalance_women.jpeg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{asset('images/worldbalance_men.jpeg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{asset('images/worldbalance_kids.jpeg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{asset('images/worldbalance_accesories.jpeg')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
