    ...
    <a href="{{route('admin.list-user')}}">
      ...
      <form method="POST" action="{{ route('admin.update-user',  $user) }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus value="{{$user->name}}" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus value="{{$user->email}}" />
